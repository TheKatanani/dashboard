...
function General(){
    return(
            <div className='container General pb-4 rounded border m-2 bg-white'style={{maxWidth:"96.5%"}}>
                ...
                <input type="text" id="FirstName" placeholder='First Name' className='w-100   rounded p-2  mb-3'></input>                    
                
                <label htmlFor='lastName' className='text-black-50'>Last Name</label>
                <input type="text" id="lastName" placeholder='Last Name' className='w-100 p-2  rounded mb-3'></input>                    
                <div className='d-flex align-items-center justify-content-between row'>
                    <div className='col-10'>
                        ...
                        <input type="text" id="Email" placeholder='moha@gmail.com' className='w-100 p-2 bg-light rounded mb-3'></input>                    
                    </div>
