...
function  PlansComp(props){
    ...
    return(
        <div className="container pb-2 m-2 bg-white p-2">
            ...
            <div>
                {props.features.map((x,i)=>   
                    (
                        <>
                        <div className="d-flex justify-content-between border-bottom mt-2 p-1 align-items-center">
